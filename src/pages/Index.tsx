    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <button
                ...
                className={`text-sm font-medium transition-colors hover:text-white ${
                  currentPage === 'catalog' ? 'text-white' : 'text-white/60'
                }`}
              >
                Каталог
              </button>
              <button
                ...
                className={`text-sm font-medium transition-colors hover:text-white ${
                  currentPage === 'about' ? 'text-white' : 'text-white/60'
                }`}
              >
                О магазине
              </button>
                ...
                {mockProducts.slice(0, 3).map((product) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h4 className="text-xl font-semibold mb-2 tracking-tight">{product.name}</h4>
      ...
      {currentPage === 'catalog' && (
        <main className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="mb-8">
              <h2 className="text-4xl font-bold mb-6 tracking-tight">Каталог товаров</h2>
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-20">
                ...
                <h3 className="text-2xl font-semibold mb-2 tracking-tight">Ничего не найдено</h3>
      ...
      {currentPage === 'cart' && (
        <main className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-4xl font-bold mb-8 tracking-tight">Корзина</h2>

            {cart.length === 0 ? (
              <div className="text-center py-20">
                <Icon name="ShoppingCart" size={48} className="mx-auto text-muted-foreground mb-4" />
                <h3 className="text-2xl font-semibold mb-2 tracking-tight">Корзина пуста</h3>
      ...
      {currentPage === 'profile' && (
        <main className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto max-w-2xl">
            <h2 className="text-4xl font-bold mb-8 tracking-tight">Профиль</h2>
            <Card className="p-8">
              <div className="flex items-center gap-6 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-1 tracking-tight">Гость</h3>
      ...
      {currentPage === 'about' && (
        <main className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto max-w-3xl">
            <h2 className="text-4xl font-bold mb-8 tracking-tight">О магазине</h2>
            <Card className="p-8 space-y-6">
              <div>
                <h3 className="text-2xl font-semibold mb-4 tracking-tight">Наша философия</h3>
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-4 tracking-tight">Качество превыше всего</h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="pt-6 border-t">
                <h3 className="text-xl font-semibold mb-4 tracking-tight">Свяжитесь с нами</h3>
